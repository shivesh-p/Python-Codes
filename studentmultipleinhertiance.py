...
class faculty:
    ...
    def __init__(self,fname,fsubject):
...
class university (student,faculty,branch,department):
    ...
    def __init__(self, name, year, fname, fsubject, bname, bcode, dname,uname,dno):
        ...
        faculty.__init__ (self,fname, fsubject)
        branch.__init__(self,bname, bcode)
